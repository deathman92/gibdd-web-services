package ru.vlsu.gibdd.webservice.signature.config;
...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public static final String NAMESPACE_URI = "http://vlsu.ru/signature";
    ...
    private static final String[] SCHEMA_LOCATIONS = {  "schema/import/CitizenType.xsd",
                                                        ...
                                                        "schema/SignatureWebServiceTypes.xsd"};
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchemaCollection xsdSchemaCollection) {
        ...
        wsdl11Definition.setLocationUri("/services/Signature");
