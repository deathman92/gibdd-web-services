...
public class VerifySignatureResponseIo
    extends AbstractIo
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof VerifySignatureResponseIo)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final VerifySignatureResponseIo that = ((VerifySignatureResponseIo) object);
        {
            boolean lhsResult;
