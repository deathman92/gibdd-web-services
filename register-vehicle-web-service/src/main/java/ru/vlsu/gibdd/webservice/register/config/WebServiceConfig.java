package ru.vlsu.gibdd.webservice.register.config;
...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public static final String NAMESPACE_URI = "http://vlsu.ru/registervehicle";
    private static final String PORT_TYPE_NAME = "RegisterVehicle";
    ...
    private static final String[] SCHEMA_LOCATIONS = {  "schema/import/CitizenType.xsd",
                                                        ...
                                                        "schema/OwnerType.xsd",
                                                        "schema/RegistrationCertificateType.xsd",
                                                        "schema/RegisterVehicleWebServiceTypes.xsd"};
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchemaCollection xsdSchemaCollection) {
        ...
        wsdl11Definition.setLocationUri("/services/RegisterVehicle");
