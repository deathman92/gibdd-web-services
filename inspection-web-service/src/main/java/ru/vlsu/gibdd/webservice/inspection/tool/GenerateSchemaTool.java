package ru.vlsu.gibdd.webservice.inspection.tool;
...
public class GenerateSchemaTool {
    ...
    private static void generateDdl() throws Exception {
        ...
        packages.add("ru.vlsu.gibdd.webservice.common.domain");
        packages.add("ru.vlsu.gibdd.webservice.inspection.domain");
