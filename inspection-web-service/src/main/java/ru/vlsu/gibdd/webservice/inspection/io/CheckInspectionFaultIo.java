...
@XmlRootElement(name = "CheckInspectionFault")
public class CheckInspectionFaultIo
    extends AbstractIo
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CheckInspectionFaultIo)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CheckInspectionFaultIo that = ((CheckInspectionFaultIo) object);
        {
            String lhsMessage;
