...
@XmlRootElement(name = "CheckInspectionResponse")
public class CheckInspectionResponseIo
    extends AbstractIo
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CheckInspectionResponseIo)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CheckInspectionResponseIo that = ((CheckInspectionResponseIo) object);
        {
            boolean lhsResult;
